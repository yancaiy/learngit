...
# Boot will occupied the ending 0xC000(48K) Bytes in RAM.
# So, the remain RAM size will be the whole RAM(0x90000) size minus 0xd000, equals 0x83000.
EXT_RAM_SIZE ?= 0x83000
endif
