...
#ifdef FUNC_SAFETY
uint8_t fmcw_radio_sm_ldo_monitor_IRQ(fmcw_radio_t *radio, uint8_t ldo_part);
...
uint8_t fmcw_radio_sm_saturation_detector_fault_injection_IRQ(fmcw_radio_t *radio);
#endif
