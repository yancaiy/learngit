...
COMMON_COMPILE_PREREQUISITES += ./options/toolchain/toolchain_$(VALID_TOOLCHAIN).mk
include ./options/toolchain/toolchain_$(VALID_TOOLCHAIN).mk
else
...
LINK_FILE_OPT +=-DFLASH_TYPE=$(FLASH_TYPE)

ifeq ($(FLASH_TYPE), s25fls)
LINK_FILE_OPT +=-DNOR_FLASH_CFI=1
else
LINK_FILE_OPT +=-DNOR_FLASH_CFI=0
endif