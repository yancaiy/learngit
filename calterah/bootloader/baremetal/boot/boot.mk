...
APPL_DEFINES += -DFLASH_XIP_EN=$(FLASH_XIP)
...
PROJECT_CSRCS += boot/fmcw_radio_reset.c
...
BOOT_INCDIRS += boot
BOOT_INCDIRS += $(CALTERAH_ROOT)/include
...
ifneq ($(CAN_OTA),)
APPL_DEFINES += -DSYSTEM_CAN_OTA -DCAN_UDS
endif
APPL_DEFINES += -DFMCW_SDM_FREQ=$(FMCW_SDM_FREQ)
ifneq ($(BOOT_USE_HW_CRC),)
APPL_DEFINES += -DBOOT_USE_HW_CRC
endif

ifneq ($(BOOT_USE_ENHANCE_CACHE),)
APPL_DEFINES += -DBOOT_USE_ENHANCE_CACHE=$(BOOT_USE_ENHANCE_CACHE)
endif

ifneq ($(BOOT_USE_XIP_LOAD_FW),)
APPL_DEFINES += -DBOOT_USE_XIP_LOAD_FW=$(BOOT_USE_XIP_LOAD_FW)
endif

ifneq ($(OTA_ENC_SUPPORT),)
APPL_DEFINES += -DOTA_ENC_SUPPORT=$(OTA_ENC_SUPPORT)
endif
...
APPL_LINK_FILE = ./boot/linker_gnu_xip.ldf
endif
endif
endif
...
APPL_LINK_FILE = ./boot/linker_mw_xip.ldf
endif
endif
endif
...
ifneq ($(CAN_OTA),)
include ./uds/uds.mk
COMMON_COMPILE_PREREQUISITES += ./uds/uds.mk
endif
