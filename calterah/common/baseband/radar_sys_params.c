...
static sensor_config_t* bb_get_cfg(radar_sys_params_t *sys_params)
{
...
{
        sensor_config_t* cfg = bb_get_cfg(sys_params);
        float r, v;
...
void radar_param_rv2fft(const radar_sys_params_t *sys_params,
                        ...
                        int32_t *p)
{
        sensor_config_t* cfg = bb_get_cfg((radar_sys_params_t *)sys_params);
