...
ifeq ($(TOOLCHAIN), mw)
$(info  Metaware Version: $(strip $(shell ccac --version | findstr Revision)))
else ifeq ($(TOOLCHAIN), gnu)
$(info  ARC GNU Version: $(shell arc-elf32-gcc --version | findstr arc-elf32-gcc))
else
$(info  Unknown Tool Chain)
endif
