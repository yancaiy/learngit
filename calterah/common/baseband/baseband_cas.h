...
#define MAX_TX_OBJ_NUM                    512  // tx buf size for one transmit
...
#define SLV_HEAD_SIZ                      1     // For master and slave frame counters synchronization,
                                                // slave head is slave frame counter which is a uint32_t type data.
